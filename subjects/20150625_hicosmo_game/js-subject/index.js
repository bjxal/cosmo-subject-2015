...
function gameInit(){
    ...
    createjs.Sound.registerSound( {src:"img-subject/end.mp3", id:"end"} );
    createjs.Sound.registerSound( {src:"img-subject/tap.mp3", id:"tap"} );
    gameRestart();
}
...
var mebtnopenurl = 'http://m.cosmopolitan.com.cn/cosmowww/2015/0710/13163.shtml';
function shareText( score ){
    ...
    if( score >= 130 )
        return '<span class="score_txt">棒棒哒，抢了<em class="timer count-title" id="count-number" data-to="'+score+'" data-speed="1500"></em>件</span><br/>如果没有玩尽兴，请速度点击下方<br>一起hi<br>';
}
function share( type ){
...
function showWeixinShade(qr, step1, step2, step3){
    ...
    var i = 1;
    html += '<div id="weixin-shade-step3" class="step"><img src="img-subject/wx_share.gif"/> </div>';
    html += '</div>';
    s.innerHTML += html;
    body.appendChild(s);
}