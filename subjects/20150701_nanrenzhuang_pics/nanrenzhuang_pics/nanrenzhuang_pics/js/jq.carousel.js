    ...
    var carousel = (function() {
        ...
        var carousel = function(containerEl, opts) {
            ...
            if (this instanceof carousel) {
                ...
                this.pagingNum = this.pagingNum ? document.getElementById(this.pagingNum) : null;
        ...
        carousel.prototype = {
            ...
            touchEnd: function(e) {
                ...
                try {
                    ...
                    if (endPos > 0) {
                        ...
                        if(this.pagingNum){
                            var num_act = document.getElementById("pagingNum_act");
                            num_act.innerHTML = parseInt(currInd)+1;
                        }
            ...
            onMoveIndex: function(newInd,transitionTime) {
                ...
                var runFinal = false;
                    ...
                    if(this.pagingNum){
                        var num_act = document.getElementById("pagingNum_act");
                        num_act.innerHTML = parseInt(this.carouselIndex)+1;
                    }
                    if (runFinal && this.pagingFunction && typeof this.pagingFunction == "function")
            ...
            refreshItems: function() {
                ...
                if(this.pagingNum){
                    this.pagingNum.innerHTML = "<span id='pagingNum_act'>"+(parseInt(this.carouselIndex)+1)+"</span>/"+this.childrenCount;
                }
                if (this.pagingDiv) {
